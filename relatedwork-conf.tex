...
\subfloat[Distribution of Twitter]{\includegraphics[width = 1.68in, height = 3.5cm]{fig/twitter.eps}\label{fig:twitter}}
    \hspace{0.23cm}
    \subfloat[Distribution of web-BerkStan]{\includegraphics[width =1.68in, height = 3.5cm]{fig/web.eps}\label{fig:web}}\\
%\includegraphics[width=.5\textwidth]{fig/pareto_index_hash}
\caption{The distributions of group sizes in two real data sets.}
